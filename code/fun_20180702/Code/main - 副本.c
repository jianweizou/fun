...
unsigned int battery_full_debounce;
...
//				if (P06 == 1)
//				{
//					battery_full_debounce++;
//					#if UART_TEST
//					printf("bd=%d\n",battery_full_debounce);
//					#endif
//					if (battery_full_debounce > 10)
//					{
//						battery_full_debounce = 11;
//						isWaitTurnOffCharging = 1;
//					}
//				}
//				else
//				{
//					battery_full_debounce = 0;
//				}
			}
			if (Motor_Level == 1)
			{
			...
			first_run_times++;
			if(first_run_times>100)
				first_run_times=100;
			if ((isfirstenterdpd == 0)&&(first_run_times<100))
			{
//				if (adcvaluetemp < 2800)
//					adcvalue = 3000;
...
//			printf("bat=%0.4f\n",bat_val);
			...
			else if (adcvalue > 3120)	//>75%	7.9v	0xCA0	
			{
				templevel = 5;
			}
			else if (adcvalue > 2970)	//>50%	7.7v	0xC40
			{
				templevel = 4;
			}
			else if (adcvalue > 2850)	//>25%	7.5		0xBE0
			{
				templevel = 3;
			}
			else if (adcvalue > 2780)	//10%	7.2v	0xBA0
			{
				templevel = 2;
			}
			else
...
//			}
		...
		//ADC Porcess
		if (get_motor_level()!=0)
		{
			getbatlevel(40);
		}
		else if (ischarging == 1)
		{
			if (adc_wait_cnt == 2000)
			{
				//disable charging
				adc_wait_cnt = 2001;
				P06 = 0;
			}
			else if (adc_wait_cnt >= 2050)
			{
				getbatlevel(0);
				P06 = 1;
				adc_wait_cnt = 0;
